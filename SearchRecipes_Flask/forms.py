...
def get_data(meal, include, exclude):
    ...
    main_functions.save_to_file(response, "SearchRecipes_Flask/JSON_Files/spoontacular_response.json")

    # Read the JSON file and save it to variable
    recipes = main_functions.read_from_file("SearchRecipes_Flask/JSON_Files/spoontacular_response.json")
